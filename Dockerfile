...
RUN CGO_ENABLED=0 GOOS=linux go build \
    -ldflags="-w -s -X github.com/sterango/redstonecore-agent/internal/version.Version=1.4.2 -X github.com/sterango/redstonecore-agent/internal/version.BuildTime=$(date -u +%Y-%m-%dT%H:%M:%SZ)" \
    -o /rsc \
    ./cmd/rsc
